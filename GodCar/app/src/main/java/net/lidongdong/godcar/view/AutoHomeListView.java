package net.lidongdong.godcar.view;
...
public class AutoHomeListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private void init(Context context) {
        ...
        headerView = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.item_autohome, null, false);
        ...
        animation = AnimationUtils.loadAnimation(context, R.anim.pointer);
